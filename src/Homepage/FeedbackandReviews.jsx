...
import premImage1 from '/FeedbacksandReviews/review image 1.avif'
import premImage2 from '/FeedbacksandReviews/review image 2.avif'
import premImage3 from '/FeedbacksandReviews/review image 3.avif'
import premImage4 from '/FeedbacksandReviews/review image 4.avif'
import premImage5 from '/FeedbacksandReviews/review image 5.avif'
import googleLogo from '/FeedbacksandReviews/google-logo.avif' // Update with the correct path to your Google logo
                    ...
                    >
                      <div className="card-body-wrapper d-flex">
                        ...
                        <Card.Body>
                          ...
                          <Card.Title className="review-name">
                            {review.name}
                          </Card.Title>
