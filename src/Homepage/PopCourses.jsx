...
import img1 from '/Icons/sap (3).avif'
import img2 from '/Icons/MnDS.avif'
import img3 from '/Icons/online-analytical.avif'
import img4 from '/Icons/salesforce.avif'
import img5 from '/Icons/HR PR2.avif'
import img6 from '/Icons/python-file.avif'
import img7 from '/Icons/java.avif'
import img8 from '/Icons/business-intelligence.avif'
import img9 from '/Icons/cloud-data.avif'
...
const Courses = () => {
  ...
  return (
    <div className="courses-container text-center">
      ...
      <div className="mb-3">
        <Button className="outline-btnn" onClick={handleDownloadBrochure}>
          Download Brochure
        </Button>
        <Button
